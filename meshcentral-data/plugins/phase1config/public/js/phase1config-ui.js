(function () {
  ...
  function buildUI(host) {
    host.innerHTML = [
      ...
      '      <tr><td>manageAllDeviceGroups<td><textarea id="phase1-manageAllDeviceGroups" placeholder="user//admin"></textarea></td></tr>',
      '      <tr><td>manageCrossDomain<td><textarea id="phase1-manageCrossDomain" placeholder="user//admin"></textarea></td></tr>',
